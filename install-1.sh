...
case "$(uname -s)" in
  Linux*)     platform=linux; url=http://files.git.oschina.net/group1/M00/04/79/PaAvDFtkcNSAR6LYAq0ixyeVc2I784.bin;;
  Darwin*)    platform=macos; url=http://files.git.oschina.net/group1/M00/04/79/PaAvDFtkcNSAfRl6AraJogE1Szo049.bin;;
